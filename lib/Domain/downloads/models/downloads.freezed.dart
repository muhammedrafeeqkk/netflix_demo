...
abstract class $DownloadsCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: "backdrop_path") String? backGroundPath,
...
class _$_Downloads implements _Downloads {
  const _$_Downloads(
      {@JsonKey(name: "backdrop_path") required this.backGroundPath,
  ...
  @override
  String toString() {
    return 'Downloads(backGroundPath: $backGroundPath, posterPath: $posterPath, title: $title)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, backGroundPath, posterPath, title);
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
      {@JsonKey(name: "backdrop_path") required final String? backGroundPath,
